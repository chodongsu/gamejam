...
# 호감도 창
    frame:            
        ...
        vbox:                           
            text "서가을{space=15}[love[0]]" size 25             
            bar:                    
                value love[0]                    
                # 호감도 바 범위                    
                range 100                                  
    ...
    frame:            
        ...
        vbox:                           
            ...
            bar:                    
                ...
                # padding을 쓸 경우, 바, 텍스트 간격 모두 동일하게 적용됨                
            text " " size 3                 
            text "윤보미{space=15}[love[1]]" size 25   
    ...
    frame:            
        ...
        vbox:                           
            ...
            bar:
                ...
                style "fixed_bar"                 
            text " " size 3                 
            text "한겨울{space=15}[love[2]]" size 25             
            bar:                    
                value love[2]                    
                range 100                    
                xalign 0.5                    
