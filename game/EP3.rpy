...
image ep3_gyeoul annoying = "images/ep3/characters/gyeoul_annoying.png"
image ep3_pdf = "images/ep3/etc/lapiscin_pdf.png"
...
#!!!상태창 여기서부터 띄움
    ...
    narration "[e] 옆자리에서 겨울이가 컴퓨터를 하고있다."
...
#겨울웃는사진
    ...
    e "(...성격 있어 보이는데... 보기랑 다르게 엄청 착한가 보다...)"
#겨울이컴퓨터하는사진으로
    show ep3_gyeoul computer
    e "..."
...
#!!!수정시작
    e "(뭐지... 나.. 지금... 이상한가...?)"
    #!!!멘트추가
    e "(방금... 뭔가 눈빛이 차가워진 것 같은데...)"
    show ep3_gyeoul angry with vpunch
    gyeoul "뭐야?"
    $ love[2] -= 5 #!!!호감도 깎임 겨울 5

    e "그... 그게... 그..."

    gyeoul "뭐야? 너 말 못해?"
    $ love[2] -= 5 #!!!호감도 깎임 겨울호감 0

# 뭘 해도 포상임
    menu :
        "1. ... ...":
            $ love[2] -= 3 #!!!호감도 깎임 겨울호감 -3
            show ep3_gyeoul annoying with vpunch
            gyeoul "이딴 애랑 같이 동료 학습을 해야 한다고?"
            
        "2. …미…미안":
            $ love[2] -= 8 #!!!호감도 깎임 겨울 호감 -8
            show ep3_gyeoul annoying with vpunch
            gyeoul "아 진짜 짜증나게. 개찐따가 뭐라는거야."
...
#페이드아웃
    ...
    narration "다사다난 했던 하루를 마무리하며 [e]는 잠이 들었다..."
