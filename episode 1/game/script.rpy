...
image gyeoul falldown= "images/ep1/characters/가을_넘어짐.PNG"
image gyeoul upside = "/images/ep1/characters/가을_밑에서봄.PNG"
image gyeoul trouble = "images/ep1/characters/가을_곤란.PNG"
image gyeoul smile = "images/ep1/characters/가을_웃음.PNG"
...
#배경 : 검은색 배경
    ...
    # narration "당신의 이름은 [player_name]입니다."
    scene outside
...
#이미지 : 가을이내려다보는 구도
    ...
    pause 1.0
    scene oasis with dissolve
    show gyeoul upside with dissolve
    gaeul "저기...괜찮아요...?"
